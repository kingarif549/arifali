# decompile by Aarif Ali
# source code by Arif Ali
# arif ali decompile done 3:)
...
def reg():
    ...
    print ''
    print ''
    print '\x1b[1;92m  [Connected With Arif Servers]'
    print ''
...
def reg2():
    ...
    print ''
    print '\x1b[1;96m '
    print ' \xe2\x80\xa2 THIS TOOL IS COMPLETELY CODED BY Arif Ali \xe2\x80\xa2 '
    time.sleep(5)
    login()
...
def menu():
    ...
    print ' [3] CONTACT WITH OWNER '03483682061
    print ''
    menu_option()
...
def menu_option():
    ...
    if select == '1':
        ...
        os.system('xdg-open https://www.facebook.com/profile.php?id=100009251832089')
        menu()
    elif select == '3':
        os.system('xdg-open https://www.facebook.com/hmansoorali')
        menu()
    else:
        print ''
